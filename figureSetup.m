...
% set baseline color
baselineColor = repmat(zeros(length(obj.f.v),1),1,3);
...
hFig.Position = [5, 5, camParams.imageRes/scale];
...
set(hFig.CurrentAxes,'LooseInset',get(hFig.CurrentAxes,'TightInset'));% remove padding of the plot axes
colormap(cmap)
